The current directory is home to all files generated during completion of the '0x12' project by ALX to its Software Engineering program, namely <javascript-warm_up>.
