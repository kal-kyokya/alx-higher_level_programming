This directory is home to all files needed for successful completion of the 'Inheritance' project provided by ALX Africa to the Software Engineering program.
